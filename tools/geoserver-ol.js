            ...
            function init(){
                ...
                var bounds = new OpenLayers.Bounds(
                    444047.6409000053, 2840445.9278596244,
                    447537.6409000053, 2842765.9278596244
                );
                var options = {
                    controls: [],
                    maxExtent: bounds,
                    maxResolution: 13.6328125,
                    projection: "EPSG:2384",
                    units: 'm'
                };
                ...
                tiled = new OpenLayers.Layer.WMS(
                    "field_Zhuxi:field_Zhuxi - Tiled", "http://localhost:8080/geoserver/field_Zhuxi/wms",
                    {
                        "STYLES": '',
                        "LAYERS": 'field_Zhuxi:field_Zhuxi',
                        format: format
                    },
                    {
                        buffer: 0,
                ...
                untiled = new OpenLayers.Layer.WMS(
                    "field_Zhuxi:field_Zhuxi - Untiled", "http://localhost:8080/geoserver/field_Zhuxi/wms",
                    {
                        "STYLES": '',
                        "LAYERS": 'field_Zhuxi:field_Zhuxi',
                        format: format
                ...
                map.events.register('click', map, function (e) {
                    ...
                    OpenLayers.loadURL("http://localhost:8080/geoserver/field_Zhuxi/wms", params, this, setHTML, setHTML);
